# GNOME PIN unlock
A PIN login system for GNOME.

# Features
- Adds a PIN entry system to the lock screen to facilitate typing in a PIN.
- Allows the user to set a PIN to unlock their device. This PIN only works **after** initial login.
